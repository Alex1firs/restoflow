        ...
        <div className="max-w-7xl mx-auto">
          <div className="grid grid-cols-2 md:grid-cols-4 gap-8 mb-16">
            <div className="col-span-2 md:col-span-1">
              <div className="font-black italic uppercase tracking-tighter text-xl mb-4">
            ...
            <div>
              ...
              <ul className="space-y-3 text-sm text-white/50">
                ...
                <li><a href="mailto:support@restoflow.com" className="hover:text-orange-500 transition-colors">Email Us</a></li>
              </ul>
            </div>
          </div>
